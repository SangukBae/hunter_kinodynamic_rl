...
| TRACTOR-TQC | protocol v1 + 616 scenarios + A7/A8/A9 frozen | 0 | 0 | IMPLEMENTED / UNTRAINED |
...
|---|---|---|
| B0–B8, B12 | see frozen `tractor_protocol_v1` / `RESEARCH_PROTOCOL` | FROZEN / UNTRAINED |
